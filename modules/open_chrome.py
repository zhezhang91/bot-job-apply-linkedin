...
from config.settings import run_in_background, stealth_mode, disable_extensions, safe_mode, file_name, failed_file_name, saved_jobs_file_name, logs_folder_path, generated_resume_path
...
from modules.helpers import find_default_profile_directory, critical_error_log, print_lg, get_chrome_major_version
from selenium.common.exceptions import SessionNotCreatedException

def createChromeSession(isRetry: bool = False):
    make_directories([file_name,failed_file_name,saved_jobs_file_name,logs_folder_path+"/screenshots",default_resume_path,generated_resume_path+"/temp"])
    ...
    if stealth_mode:
        ...
        #     print_lg("(Undetected Mode) Got '{}' when using pre-installed ChromeDriver.".format(type(e).__name__)) 
            ...
            if chrome_version:
                print_lg(f"Detected Chrome version {chrome_version}, matching ChromeDriver...")
