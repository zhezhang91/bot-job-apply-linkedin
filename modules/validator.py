...
def validate_personals() -> None | ValueError | TypeError:
    ...
    check_string(email, "email", min_length=5)
...
def validate_search() -> None | ValueError | TypeError:
    ...
    check_boolean(apply_saved_jobs_first, "apply_saved_jobs_first")
    check_boolean(search_new_jobs_after_saved, "search_new_jobs_after_saved")
    check_string(saved_jobs_url, "saved_jobs_url")
    check_int(saved_jobs_limit, "saved_jobs_limit", 0)
    check_boolean(relax_filters_for_saved_jobs, "relax_filters_for_saved_jobs")
    ...
    check_int(max_days_since_posted, "max_days_since_posted", 0)
    ...
    check_list(allowed_locations, "allowed_locations")
    check_list(allowed_metro_locations, "allowed_metro_locations")
    check_boolean(allow_remote_canada, "allow_remote_canada")
    check_list(blocked_locations, "blocked_locations")
    check_list(allowed_job_title_keywords, "allowed_job_title_keywords")
    check_list(blocked_job_title_keywords, "blocked_job_title_keywords")
    check_list(blocked_company_name_keywords, "blocked_company_name_keywords")
    check_int(min_company_size, "min_company_size", 0)
    check_int(max_company_size, "max_company_size", 0)
    check_boolean(skip_unknown_company_size, "skip_unknown_company_size")
...
def validate_settings() -> None | ValueError | TypeError:
    ...
    check_string(saved_jobs_file_name, "saved_jobs_file_name", min_length=1)
    check_boolean(save_jobs_only, "save_jobs_only")
