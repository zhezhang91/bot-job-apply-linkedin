...
# Your legal name
first_name = "Jingyi"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = ""            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Ma"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "+13439886413"        # Enter your 10 digit number in quotes Eg: "9876543210"

# Email address used on Easy Apply applications
email = "jingyima93@gmail.com"

# What is your current city?
current_city = "Ottawa"                  # Los Angeles, San Francisco, etc.
'''
